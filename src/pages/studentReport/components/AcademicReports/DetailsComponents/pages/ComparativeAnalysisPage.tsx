        ...
        <SectionDiv>
          <ResultTableWrapper>
            <div className={"result-row"}>
              <div>
                <b>Arts</b>
                <div>The comparative result for this arts</div>
              </div>
              <div className={"result-table"}>
                <ComparativeBarGraph
                  cohortScores={[30, 40, 75, 80, 90, 99]}
                  currentStudentScore={38}
                />
              </div>
            </div>
          </ResultTableWrapper>
        ...
        <SectionDiv>
          <ResultTableWrapper>
            <div className={"result-row"}>
              <div>
                <b>English</b>
                <div>The comparative result for this English</div>
              </div>
              <div className={"result-table"}>
                <ComparativeBarGraph
                  cohortScores={[45, 60, 70, 80, 87, 98]}
                  currentStudentScore={98}
                />
              </div>
            </div>
          </ResultTableWrapper>
        ...
        <SectionDiv>
          <ResultTableWrapper>
            <div className={"result-row"}>
              <div>
                <b>Humanities</b>
                <div>The comparative result for this Humanities</div>
              </div>
              <div className={"result-table"}>
                <ComparativeBarGraph
                  cohortScores={[10, 30, 50, 70, 80, 90]}
                  currentStudentScore={100}
                />
              </div>
            </div>
          </ResultTableWrapper>
        ...
        <SectionDiv>
          <ResultTableWrapper>
            <div className={"result-row"}>
              <div>
                <b>Languages</b>
                <div>The comparative result for this Languages</div>
              </div>
              <div className={"result-table"}>
                <ComparativeBarGraph
                  cohortScores={[45, 75, 60, 80, 90, 98]}
                  currentStudentScore={60}
                />
              </div>
            </div>
          </ResultTableWrapper>
