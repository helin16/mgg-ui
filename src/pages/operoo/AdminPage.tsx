  ...
  return (
    <Wrapper>
      ...
      <div className={'section-row'}>
        ...
        <ModuleUserList moduleId={MGGS_MODULE_ID_OPEROO_SAFETY_ALERTS} roleId={ROLE_ID_NORMAL} showCreatingPanel={true} showDeletingBtn={true}/>
      </div>
      <div className={'section-row'}>
        <h5>Admin</h5>
        ...
        <ModuleUserList moduleId={MGGS_MODULE_ID_OPEROO_SAFETY_ALERTS} roleId={ROLE_ID_ADMIN} showCreatingPanel={true} showDeletingBtn={true}/>
      </div>
      <div className={'section-row'}>
