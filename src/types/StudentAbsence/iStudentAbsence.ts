...
export const ABSENCE_TYPE_CODE_EARLY_SIGN_OUT = '112';
export const ABSENCE_TYPE_CODE_LATE_SIGN_IN = '111';

export const ABSENCE_PERIOD_ALL_DAY = 'DAY';

export const iRecordTypeMap = {
  [STUDENT_ABSENCE_RECORD_TYPE_EARLY_SIGN_OUT]: ABSENCE_TYPE_CODE_EARLY_SIGN_OUT,
  [STUDENT_ABSENCE_RECORD_TYPE_LATE_SIGN_IN]: ABSENCE_TYPE_CODE_LATE_SIGN_IN,
}
