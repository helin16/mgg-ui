...
export const MESSAGE_TYPE_STUDENT_ABSENCE_AUTO = 'STUDENT_ABSENCE_AUTO';
export const MESSAGE_TYPE_STUDENT_ABSENCE_MANUAL = 'STUDENT_ABSENCE_MANUAL';
export const MESSAGE_TYPE_CLIPBOARD_STUDENT_CLASSES_SYNC = 'MESSAGE_TYPE_CLIPBOARD_STUDENT_CLASSES_SYNC';
export const MESSAGE_TYPE_PARENT_TEACHER_INTERVIEW = 'PARENT_TEACHER_INTERVIEW';
