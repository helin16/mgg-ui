...
const StudentNumberDetailsPopupBtn = ({records, ...rest}: iStudentNumberDetailsPopup) => {
  ...
  return (
    <>
      <Button {...rest} onClick={() => setIsShowing(true)} className={`st-no-popup-btn ${rest.className || ''}`}/>
      <PopupModal
