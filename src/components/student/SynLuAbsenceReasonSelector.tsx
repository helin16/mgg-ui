...
type iSynLuAbsenceReasonSelector = {
  ...
  onSelect?: (SynLuAbsenceReason: iAutoCompleteSingle | iAutoCompleteSingle[] | null) => void;
  allowClear?: boolean;
...
export const translateSynLuAbsenceReasonToOption = (SynLuAbsenceReason: iSynLuAbsenceReason) => {
  return {value: SynLuAbsenceReason.Code, data: SynLuAbsenceReason, label: getLabel(SynLuAbsenceReason)}
}

const SynLuAbsenceReasonSelector = ({isDisabled, values, onSelect, allowClear, classname, absenceTypeCodes = [], showIndicator = true, isMulti = false, addOtherRegardless = false}: iSynLuAbsenceReasonSelector) => {
    ...
    SynLuAbsenceReasonService.getAll({
      ...
      .then(resp => {
        ...
        setOptionsMap(resp.reduce((map, SynLuAbsenceReason) => {
          return {
            ...map,
            [SynLuAbsenceReason.Code]: translateSynLuAbsenceReasonToOption(SynLuAbsenceReason),
          };
        }, {}))
      })
      .catch(err => {
